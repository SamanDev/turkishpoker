...
function getAPI() {
  ...
  var host = {
    onlinePath: "https://api.usdtpoker.club",
    offlinePath: "https://api.usdtpoker.club",
  };
...
export const GetMenu = (siteInfo, loginToken) => {
    ...
    if (loginToken?.refer != "runner" && loginToken?.refer != "bots") {
        _ret.push({
            ...
            submenu: [
                ...
                {
                    label: "İşlem  Finansal",
                    title: "İşlem  Finansal",
    ...
    _ret.push({
        label: "Ödüller ve Bonuslar",
        title: "Ödüller ve Bonuslar",
        icon: "nkmsrxys.svg",
        aria: "garea",
        idname: "gifts",
        submenu: [
            {
                label: "Level Bonuslar",
                title: "Level Bonuslar",
                idname: "levels",
            ...
            {
                label: "Arkadaşlar Komisyonu",
                title: "Arkadaşlar Komisyonu",
                idname: "commission",
            ...
            {
                label: "Poker Rakeback",
                title: "Poker Rakeback",
                idname: "rakeback",
                icongalaxy: "rakeback",
          ...
          {
            label: "Krallar Turnuva",
            title: "Krallar Turnuva",
            idname: "topplayer",
    ...
    _ret.push(
        {
            ...
            submenu: [
                {
                    label: "Destek isteyin",
                    title: "Destek isteyin",
                    icon: "fas fa-plus",
                    component: "CashoutComponent",
                    cashMode: "Ticket",
                    size: "mini",
...

        {
            ...
            submenu: [
                ...
                {
                    label: "Değiştir Şifre Geçiş",
                    title: "Değiştir Şifre Geçiş",
                    icon: "fas fa-lock",
                    component: "CashoutComponent",
                    cashMode: "ChangePass",
                    size: "mini",
                ...
                {
                    label: "Ödüllerim Benim",
                    title: "Ödüllerim Benim",
                    icon: "fas fa-gift",
                    component: "mygifts",
                },
            ],
...
export function doDepositDollar() {
...

    {
        depositDollarData.map((game) => {
            _games.push({
                label: game.text + " Dolar",
                title: game.text + " Dolar",
                helper: game.limit,
                getwaykey: game.getwaykey,
                bonus: "",
                icon: game.icon,
...
export const updateBonusLabel = (bonusOld, loginToken, siteInfo) => {
    ...
    if (_mode == "gpass") {
        _txt = "Seviye " + _lvl + " Galaxy Sonra";
    }
    if (_mode == "league") {
        _txt = "رتİçin " + _lvl + " " + _txt;
    }
    if (_mode == "tournament" && _lvl != "") {
        _txt = "رتİçin " + _lvl + " " + _txt;
    }
    if (_mode == "tournament" && _lvl == "") {
        _txt = "Tavsiye Kişi Son Turnuva ";
    }
    if (_mode == "vip") {
        _txt = "Bonuslar Masa VIP";
    }
    if (_mode == "gift3") {
        _txt = "Hediye Altın";
    }
